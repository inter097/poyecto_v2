...
def main():
    ...
    if st.button("📌 Generar Mapas Conceptuales"):
        ...
        if not pairs:
            ...
            st.code(mermaid_code, language="mermaid")  # Mostrar el código Mermaid en el formato adecuado

            # Agregar el enlace al visualizador de Mermaid
            mermaid_viewer_url = "https://mermaid-js.github.io/mermaid-live-editor/"
            st.markdown(f"[Ver el mapa conceptual en el visualizador Mermaid]( {mermaid_viewer_url} )", unsafe_allow_html=True)
